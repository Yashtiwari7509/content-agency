...
const members = [
  ...
  },
  {
    src: Nick1,
    alt: "Nick",
    className: "lg:right-[20%] -right-20 bottom-0  lg:h-[570px] z-20 w-70 lg:w-120 translate-y-2 scale-x-[-1] translate-y-10",
  },
  {
    src: Chris1,
    alt: "Chris",
...
export default function TeamSection() {
  ...
  return (
    <section ref={sectionRef} className="relative w-full bg-transparent h-[550px] lg:h-[700px]">
      ...
      <div
        className="relative lg:max-w-360 max-w-100 mx-auto  -translate-y-60 lg:-translate-y-10 h-[600px]"
      >
