...
const FixedText = () => {
  ...
  return (
    <div
      ref={fixedTextRef}
      className="relative max-w-7xl h-dvh overflow-hidden mx-auto flex justify-center items-center select-none"
    >
      <div className="fixed-text-container md:w-lg w-80 text-2xl flex h-8 md:text-4xl md:h-10 font-medium relative">
        <div className="text-nowrap w-fit relative z-10">We'll handle Your's</div>
        <img
          src={brush}
          style={{ color: "black !important" }}
          className="absolute h-24 -bottom-10  right-0 z-10"
          alt=""
        />
        <div className="flex w-34 md:w-50 h-full z-10 -right-6 flex-col ml-2 overflow-hidden  text- absolute text-itemss">
