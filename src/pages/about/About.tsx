    ...
    <div className="relative w-screen h-[200vh]">
      ...
      <div className="w-screen h-screen sticky top-0 ">
        <div className="w-full h-full relative  ">
          ...
          >
            <h1 className="text-4xl md:text-7xl text-zinc-800  whitespace-nowrap font-black ">The xPro</h1>
            <h1 className="px-10 md:px-20 py-2  bottom-0 text-white  z-10 text-xs md:text-lg  bg-black absolute ">Agency</h1>
          </div>
          <SvgText id="masktwo" className="top-[25%] left-[10%] lg:left-[21%]" textClass="rotate-75  h-fit w-fit left-15 lg:top-[150%] ">
    ...
    <div className={cn("absolute", className)}>
      ...
      <div className={cn("absolute", textClass)}>
        ...
        >
          ...
          <g mask={`url(#mask${id})`}>
            <path id={`${id}`} d="M0.0847168 506.09C152.918 491.59 514.385 370.09 737.585 0.0898361" stroke="black" strokeWidth="49" />
          </g>
        </svg>
      </div>
    </div>
